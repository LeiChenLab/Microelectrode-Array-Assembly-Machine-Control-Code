...
def motor_control(ser):
    while True:
        command = input("Enter 'move' to move the stage, 'check' to check position, 'home' to home an axis, or 'exit' to quit: ").strip().lower()
        ...
        if command == 'move':
            ...
            displacement = input("Enter displacement (pulse number or degrees for R axis): ").strip()
            ...
            axis = input("Enter axis (X, Y, Z, r, T) to check position: ").strip().upper()
            position = check_position(ser, axis)
            print(f"Current {axis} position: {position}")

        elif command == 'home':
            axis = input("Enter axis (X, Y, Z, r, T) to home: ").strip().upper()
            home_axis(ser, axis)

        else:
            print("Invalid command. Please enter 'move', 'check', 'home', or 'exit'.")

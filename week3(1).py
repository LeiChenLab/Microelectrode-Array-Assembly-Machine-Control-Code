...
def change_motor_direction(ser):
    ...
    ser.write(direction_command.encode())
...
def main():
    try:
        ...
        if device == 'arduino':
            ...
            if ser:
                print("Enter 't' to toggle relay, 'd' to change motor direction, 'm' for motor control, 's' to stop motor, or 'e' to set extruder motor position")
                ...
                while True:
                    ...
                    if command == 't':
                        ...
                        print("Invalid command. Please enter 't', 'd', 'm', 's', 'e', 'test', or 'exit'.")
            ...
            if ser:
                while True:
                    ...
                    if command == 'move':
                        ...
                        print("Invalid command. Please entter 'move', 'stop', or 'exit'.")
